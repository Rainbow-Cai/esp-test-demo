...
# 此例程基于 ESP32 设备开启 WiFi AP 热点，然后启 HTTP Server ,支持在 HTTP Server 界面修改 WiFi AP 热点信息

# 下载固件后，手机或电脑连接 WiFi AP 热点，然后在浏览器访问：http://192.168.4.1:80 进入 server 网页修改 WiFi AP 热点信息
